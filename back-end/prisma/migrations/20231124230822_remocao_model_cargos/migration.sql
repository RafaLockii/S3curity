/*
  ...
  - You are about to drop the column `cargo_id` on the `funcionario` table. All the data in the column will be lost.
  - You are about to drop the `cargos` table. If the table is not empty, all the data it contains will be lost.
  - Made the column `empresa_id` on table `funcionario` required. This step will fail if there are existing NULL values in that column.
...
-- AlterTable
ALTER TABLE `funcionario` DROP COLUMN `cargo_id`,
